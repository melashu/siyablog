...
describe User, type: :feature do
  ...
  it 'I can see the number of posts Ema has written.' do
    ...
    Post.create(author: @user1, title: 'Introduction to rails', text: 'Rails is a web', comment_counter: 0,
                like_counter: 0)
    Post.create(author: @user1, title: 'Introduction to testing', text: 'Rails is a web', comment_counter: 0,
                like_counter: 0)
    Post.create(author: @user1, title: 'Introduction to Capybara', text: 'Rails is a web', comment_counter: 0,
                like_counter: 0)
  ...
  it 'I can see the users first 3 posts.' do
    ...
    Post.create(author: @user1, title: 'Introduction to Capybara', text: 'Rails is a web', comment_counter: 0,
                like_counter: 0)
    Post.create(author: @user1, title: 'Introduction to migration', text: 'Rails is a web', comment_counter: 0,
                like_counter: 0)
    visit user_path(@user1)
  ...
  it 'When I click a users post, it redirects me to that posts show page.' do
    post = Post.create(author: @user1, title: 'Introduction to rails', text: 'Rails is a web', comment_counter: 0,
                       like_counter: 0)
